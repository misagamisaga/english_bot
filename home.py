...
def login():
    ...
    with st.form("Log in"):
        ...
        submit_button3 = False  # 取消注册按钮，暂时不用
...
# )
# request_1 = st.Page(
#     "Requester/assistant.py", 
#     title="AI英语", 
#     icon=":material/timeline:", 
#     default=(st.session_state.role in ["Admin", "Requester"]),
# )
request_2 = st.Page(
...
request_pages = [request_2, request_3, request_4]
# player_pages = []  # 以后情景训练模式用的页面
admin_pages = []
...
if st.session_state.role == "Admin":
    page_dict["管理员-控制台"] = admin_pages
if st.session_state.role in ["Requester", "Admin"]:
    page_dict["AI应用"] = request_pages
# if st.session_state.role in ["Requester", "Admin", "player"]:  # 以后情景训练模式用的页面
#     page_dict["情境训练"] = player_pages
